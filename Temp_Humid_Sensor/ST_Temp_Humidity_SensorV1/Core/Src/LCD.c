...
void HD44780_PrintTemp(const char* data)
{
  HD44780_Clear(); // Clear the LCD display
  HD44780_SetCursor(0, 0);// Set the cursor to the first column, first row
  HD44780_PrintStr("Temp: "); // Display a label or message
  HD44780_SetCursor(6, 0); // Set the cursor to the first column, second row
  HD44780_PrintStr(data);// Print the received data on the LCD
  HD44780_SetCursor(12,0);
  HD44780_PrintStr("C");

}
void HD44780_PrintHumid(const char* data)
{
	HD44780_SetCursor(0, 1);// Set the cursor to the first column, first row
	HD44780_PrintStr("Humid: "); // Display a label or message
	HD44780_SetCursor(6, 1); // Set the cursor to the first column, second row
	HD44780_PrintStr(data);// Print the received data on the LCD
