...
void HD44780_PrintDistance(const char* data)
{

  HD44780_Clear();
  HD44780_SetCursor(0, 0);
  HD44780_PrintStr("Message Received ");
  HD44780_SetCursor(0, 1);// Set the cursor to the first column, second row
  HD44780_PrintStr("Dist: ");
  HD44780_SetCursor(6, 1); // Set the cursor to the seventh column, second row
